                ...
                <div class="card auth-card border-0 text-light">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center mb-5">
                            <h1 class="fw-bold">Edit Trainer</h1>
                            <p class="text-body">Update trainer information</p>
                        </div>
                        ...
                        <form action="{{ route('trainers.update', $trainer->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-9">
                                        <div class="row g-4">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="firstname" value="{{ old('firstname', $trainer->firstname) }}"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="lastname" value="{{ old('lastname', $trainer->lastname) }}"
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" name="fathername" value="{{ old('fathername', $trainer->fathername) }}"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="SSN" maxlength="11" value="{{ old('SSN', $trainer->SSN) }}"
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="address" rows="3"
                                                  class="form-control @error('address') is-invalid @enderror">{{ old('address', $trainer->address) }}</textarea>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-4">
                                        ...
                                        <select name="sports_type_id" class="form-select @error('sports_type_id') is-invalid @enderror">
                                            ...
                                            @foreach($sportsTypes as $type)
                                                <option value="{{ $type->id }}" {{ old('sports_type_id', $trainer->sports_type_id) == $type->id ? 'selected' : '' }}>
                                                    {{ $type->type }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="certification" class="form-select @error('certification') is-invalid @enderror">
                                            <option value="level_1" {{ old('certification', $trainer->certification) == 'level_1' ? 'selected' : '' }}>Level 1 (Basic)</option>
                                            <option value="level_2" {{ old('certification', $trainer->certification) == 'level_2' ? 'selected' : '' }}>Level 2 (Advanced)</option>
                                            <option value="level_3" {{ old('certification', $trainer->certification) == 'level_3' ? 'selected' : '' }}>Level 3 (Professional)</option>
                                            <option value="level_4" {{ old('certification', $trainer->certification) == 'level_4' ? 'selected' : '' }}>Level 4 (Expert)</option>
                                        </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="years_of_experience" min="2" max="50"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="birthplace" value="{{ old('birthplace', $trainer->birthplace) }}"
                            ...
                            <div class="d-flex justify-content-end gap-3">
                                <a href="{{ route('trainers.show', $trainer->id) }}" class="btn btn-secondary">Cancel</a>
